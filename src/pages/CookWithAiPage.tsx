      ...
      <div className="QuickIngredContainer">
        ...
        <div className="QuickIngredContent">
          ...
          <div className="QuickIngredBody">
            ...
            {/* Cook Button */}
            <div className="CookButton" onClick={()=> navigate("/ai_generated_recipe",{state: data})}>Cook with AI</div>
          </div>
        </div>
      </div>
    </div>
